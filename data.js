...
const DEFAULT_ROUTINES = [
  ...
  // ═══ EXERCISE ═══
  {
    ...
    ethe: [
      ...
      { id: 303, name: 'Swimming session (90 min)', icon: '🏊', color: '#22d3ee', note: '// swim, run, or cycle · active recovery on Sun', xp: 30, done: false, streak: 0, groupId: 'body', days: [0, 1, 2, 4, 5, 6] },
